...
if (menuToggle && navLinks) {
  ...
  // استخدام حدث واحد فقط مع منع السلوك الافتراضي
  ...
  // منع إيماءات التمرير على القائمة المفتوحة
  navLinks.addEventListener('touchmove', (event) => {
    if (isMenuOpen) {
      event.preventDefault();
    }
  });
